...
var (
	...
	defaultConfigTable = []*entity.Config{
		...
		{ID: 107, Key: "rank.comment.vote_up", Value: `0`},
		{ID: 108, Key: "rank.comment.vote_down", Value: `0`},
		...
		{ID: 127, Key: "rank.answer.invite_someone_to_answer", Value: `0`},
