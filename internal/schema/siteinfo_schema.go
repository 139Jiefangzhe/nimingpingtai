...
var (
	...
	privilegeOptionsLevelMapping = map[string][]int{
		constant.RankQuestionAddKey:               {0, 0, 0},
		constant.RankAnswerAddKey:                 {0, 0, 0},
		constant.RankCommentAddKey:                {0, 0, 0},
		constant.RankReportAddKey:                 {0, 0, 0},
		constant.RankCommentVoteUpKey:             {0, 0, 0},
		constant.RankLinkUrlLimitKey:              {0, 0, 0},
		constant.RankQuestionVoteUpKey:            {0, 0, 0},
		constant.RankAnswerVoteUpKey:              {0, 0, 0},
		constant.RankQuestionVoteDownKey:          {0, 0, 0},
		constant.RankAnswerVoteDownKey:            {0, 0, 0},
		constant.RankInviteSomeoneToAnswerKey:     {0, 0, 0},
		constant.RankTagAddKey:                    {0, 0, 0},
